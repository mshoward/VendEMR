<?php
	...
	require_once "./webroot/library/auth.inc";
	
	$llogger->logme(3, "including login_operations.php");
	require_once "./webroot/library/authentication/login_operations.php";
	
	$llogger->logme(3, "including password_change.php");
	require_once "./webroot/library/authentication/password_change.php";
	
	$llogger->logme(3, "including password_hashing.php");
	require_once "./webroot/library/authentication/password_hashing.php";
	
	$llogger->logme(3, "including privDB.php");
	require_once "./webroot/library/authentication/privDB.php";
